...
{
  setLSB("0F", "00");
  editDetails()->patchPos(976, 26, "0F", "00");   
  setEditPages();
};
...
void menuPage_assign1::setEditPages()
{
  ...
  editDetails()->page()->newGroupBox("Assign 1 Target");
	editDetails()->page()->addTarget(0, 0, 1, 3, "0F", "00", "02", "target", "04", "06"); // Target
	editDetails()->page()->addGroupBox(1, 0, 1, 1);
	editDetails()->page()->newGroupBox("Assign 1 Source");
	editDetails()->page()->addComboBox(1, 0, 1, 1, "0F", "00", "08");                    // Source
  editDetails()->page()->addComboBox(1, 1, 1, 1, "0F", "00", "09");                    // Source Mode
  editDetails()->page()->addRange(1, 2, 1, 2, "0F", "00", "0A", "Structure");         // min/max range widget
