...
{
  /*editDetails()->page()->addLabel(0, 0, 1, 1, tr("***CAUTION*** Settings changes are automatically written to GT-5"));
  ...
  editDetails()->addPage("19", "00", "01", "00");
	...
	editDetails()->page()->newGroupBox(tr("System Midi  ***CAUTION*** Settings changes are automatically written to GT-5"));
  ...
  editDetails()->page()->newGroupBox(tr("MANUAL settings  ***CAUTION*** Settings changes are automatically written to GT-5"));
