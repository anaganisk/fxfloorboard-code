...
void menuPage_system::setEditPages()
{
  ...
  editDetails()->page()->addComboBox(2, 0, 1, 1, "03", "00", "08", "System01"); // exp pdl hold
  editDetails()->page()->addComboBox(3, 0, 1, 1, "03", "00", "09", "System01"); // dial func 
  
  editDetails()->page()->addComboBox(0, 1, 1, 1, "03", "00", "0B", "System01"); // num pdl sw    
	editDetails()->page()->addComboBox(1, 1, 1, 1, "03", "00", "0D", "System01"); // ctl pdl func 
	editDetails()->page()->addComboBox(2, 1, 1, 1, "03", "00", "0E", "System01"); // exp pdl sw func 
	editDetails()->page()->addComboBox(3, 1, 1, 1, "03", "00", "0F", "System01"); // exp pdl func 
			
	editDetails()->page()->addComboBox(0, 2, 1, 1, "03", "00", "10", "System01"); // sub exp func	
	editDetails()->page()->addComboBox(1, 2, 1, 1, "03", "00", "11", "System01"); // sub ctl1 func 	
	editDetails()->page()->addComboBox(2, 2, 1, 1, "03", "00", "10", "System01"); // sub ctl2 func 
