...
void menuPage_system::setEditPages()
{
  ...
  editDetails()->addPage("19", "00", "01", "00");
	...
	editDetails()->page()->newGroupBox("System Midi  ***CAUTION*** Settings changes are automatically written to GT-6");
  ...
  editDetails()->page()->newGroupBox("MANUAL settings  ***CAUTION*** Settings changes are automatically written to GT-6");
