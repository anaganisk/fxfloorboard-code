    ...
    : QWidget(parent)
{
  ...
  patchDialog->setGeometry(10, bottomOffset, 750, 25);  
	...
	this->eq_Button = new customButton(tr("Equalizer"), false, QPoint(90, editButtonRowOffset), this, ":/images/pushbutton.png");
	this->chorus_Button = new customButton(tr("Chorus"), false, QPoint(90, editButtonRowOffset+18), this, ":/images/pushbutton.png");
	this->distortion_Button = new customButton(tr("Distortion"), false, QPoint(170,editButtonRowOffset), this, ":/images/pushbutton.png");
	this->ns1_Button = new customButton(tr("NoiseSupp"), false, QPoint(170, editButtonRowOffset+18), this, ":/images/pushbutton.png");
	this->fx1_Button = new customButton(tr("FX-1"), false, QPoint(250, editButtonRowOffset), this, ":/images/pushbutton.png");
	this->fx2_Button = new customButton(tr("FX-2"), false, QPoint(250, editButtonRowOffset+18), this, ":/images/pushbutton.png");
	this->reverb_Button = new customButton(tr("Rev/DD/SoS"), false, QPoint(330, editButtonRowOffset), this, ":/images/pushbutton.png");
	this->delay_Button = new customButton(tr("Speaker"), false, QPoint(330, editButtonRowOffset+18), this, ":/images/pushbutton.png");
	this->compressor_Button = new customButton(tr("Compressor"), false, QPoint(410, editButtonRowOffset), this, ":/images/pushbutton.png");
	this->fv_Button = new customButton(tr("Pedals"), false, QPoint(410, editButtonRowOffset+18), this, ":/images/pushbutton.png");
    ...
    if (file.open(QIODevice::WriteOnly))
        {
                ...
                unsigned int count=0;
                        ...
                        for (int a=0;a<x;++a)
                        {
                          QString str = data.at(a);
                          //str.append(data.at(a+1));
                                bool ok;
		...
		else /* Bank is sellected. */
		{
			sysxIO->setDeviceReady(false);			// Reserve the device for interaction.
				...
				else /* User bank so we can write to it after confirmation to overwrite stored data. */
				{
				  ...
				  int bank = sysxIO->getBank();
				  int patch = sysxIO->getPatch();
				  if (bank > 10)  {u = " u"; } else {u = " U"; };          
				  
				  bankNum.append(QString::number(bank, 10));
				  if (bankNum.size() > 1){ bankNum.remove(0, 1); };
				  bankNum.prepend(u);
