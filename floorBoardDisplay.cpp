    ...
    : QWidget(parent)
{
	...
	this->temp1Display->setMainObjectName("nameMain");
        this->temp1Display->setMainText(tr("Empty ClipBoard 1"), Qt::AlignCenter);
	...
	this->temp2Display->setMainObjectName("nameMain");
        this->temp2Display->setMainText(tr("Empty ClipBoard 2"), Qt::AlignCenter);
	...
	this->temp3Display->setMainObjectName("nameMain");
        this->temp3Display->setMainText(tr("Empty ClipBoard 3"), Qt::AlignCenter);
	...
	this->temp4Display->setMainObjectName("nameMain");
        this->temp4Display->setMainText(tr("Empty ClipBoard 4"), Qt::AlignCenter);
	...
	this->temp5Display->setMainObjectName("nameMain");
        this->temp5Display->setMainText(tr("Empty ClipBoard 5"), Qt::AlignCenter);
	...
	this->compressor_Button = new customButton(tr("Compressor"), false, QPoint(460, editButtonRowOffset), this, ":/images/pushbutton.png");
	this->speaker_Button = new customButton(tr("Speaker"), false, QPoint(460, editButtonRowOffset+18), this, ":/images/pushbutton.png");
	this->loop_Button = new customButton(tr("Loop"), false, QPoint(550, editButtonRowOffset), this, ":/images/pushbutton.png");
	this->tp_Button = new customButton(tr("Tremolo/Pan"), false, QPoint(550, editButtonRowOffset+18), this, ":/images/pushbutton.png");
	...
	QObject::connect(this->loop_Button, SIGNAL(valueChanged(bool)), this->parent(), SIGNAL(loop_buttonSignal(bool)));
	QObject::connect(this->speaker_Button, SIGNAL(valueChanged(bool)), this->parent(), SIGNAL(speaker_buttonSignal(bool)));
	QObject::connect(this->tp_Button, SIGNAL(valueChanged(bool)), this->parent(), SIGNAL(tp_buttonSignal(bool)));
...
void floorBoardDisplay::temp5_paste(bool value)
{
  ...
  {
   QApplication::beep();
   sysxIO->emitStatusdBugMessage(tr("patch must be copied to Temp-5 clipboard first"));
	};
};
...
void floorBoardDisplay::connectSignal(bool value)
{
	...
	if(connectButtonActive == true && sysxIO->deviceReady())
	{
		...
		sysxIO->sendSysx(idRequestString); // GT-5 Identity Request.		
	}
	else
	{
		emit notConnected();
...
void floorBoardDisplay::connectionResult(QString sysxMsg)
{
	...
	{ 
		...
		else
		{
			...
			msgText.append("<b></font><br>");
			msgText.append(tr("Press EXIT on the GT-5 when leaving Bulk Mode."));
			msgText.append("<b></font>");
			msgBox->setText(msgText);
			msgBox->setStandardButtons(QMessageBox::Ok);
			msgBox->exec();
