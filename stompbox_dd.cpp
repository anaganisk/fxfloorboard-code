    ...
    : stompBox(parent)
{
	...
	setKnob1("0A", "00", "02");
	setKnob2("0A", "00", "05");
	setComboBox("0A", "00", "01");
	setButton("0A", "00", "00"); 
	editDetails()->patchPos(2166, 50, "0A", "00");    // sysx file offset and data length of chorus parameters x2,
	setEditPages();
};

void stompbox_dd::updateSignal()
{
	updateKnob1("0A", "00", "02");
	updateKnob2("0A", "00", "05");
	updateComboBox("0A", "00", "01");
	updateButton("0A", "00", "00");
};
