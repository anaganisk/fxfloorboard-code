...
{
  setLSB("17", "00");
  editDetails()->patchPos(1594, 34, "17", "00");    //192 sysx file offset and data length of chorus parameters x2,
        setEditPages();
};
...
void menuPage_assign2::setEditPages()
{
    ...
    editDetails()->page()->addSwitch(0, 0, 1, 1, "17", "00", "00", "middle", Qt::AlignCenter);
    ...
    editDetails()->page()->addComboBox(0, 1, 1, 1, "17", "00", "09");                    // Source Mode
    editDetails()->page()->addRange(0, 2, 1, 2, "17", "00", "0A", "Structure");         // min/max range widget
