...
{
  editDetails()->page()->addLabel(0, 1, 1, 1, "***CAUTION*** Settings changes are automatically written to GT-Pro");
 // editDetails()->page()->newGroupBox("System Preamp 1");
  ...
  editDetails()->page()->newGroupBox("SYSTEM PreAmp");
	...
	editDetails()->page()->addComboBox(3, 0, 1, 1, "02", "00", "05", "System01"); // preamp mode  (system/patch)
  ...
  editDetails()->addPage("30", "00", "02", "00");
  ...
  editDetails()->addPage("30", "00", "02", "01");

  editDetails()->page()->addLabel(0, 0, 1, 1, "***CAUTION*** Settings changes are automatically written to GT-Pro");
  editDetails()->page()->newGroupBox("Custom Speaker 1");         
  editDetails()->page()->addComboBox(0, 0, 1, 1, "03", "00", "00", "System03"); // speaker type
  ...
  editDetails()->page()->addComboBox(0, 0, 1, 1, "03", "01", "00", "System03"); // speaker type
  ...
  editDetails()->page()->addKnob(0, 4, 1, 1, "03", "01", "04", "System03"); // cab type   
	editDetails()->page()->addGroupBox(2, 0, 1, 2);                       
  editDetails()->addPage("30", "00", "02", "02");
  ...
  editDetails()->addPage("30", "00", "02", "03");
  ...
  editDetails()->addPage("30", "00", "02", "04");
