...
void menuPage_midi::setEditPages()
{
  ...
  editDetails()->page()->newGroupBox("midi 1 Target");
	editDetails()->page()->addTarget(0, 0, 1, 3, "0B", "00", "21", "target","target", 120); // Target
	editDetails()->page()->addGroupBox(0, 0, 1, 1);
	editDetails()->page()->newGroupBox("midi 1 Internal Pedal");
  ...
  editDetails()->page()->addKnob(0, 1, 1, 1, "0B", "00", "2C");                        // Internal Pedal Time
	...
	editDetails()->page()->newGroupBox("midi 1 Source");
  ...
  editDetails()->page()->addGroupBox(1, 0, 1, 1);
	...
	editDetails()->page()->newStackField(0);
	editDetails()->page()->newGroupBox("midi 2 Target");
	editDetails()->page()->addTarget(0, 0, 1, 3, "0B", "00", "31", "target","target", 120); // Target
	editDetails()->page()->addGroupBox(0, 0, 1, 1);
	editDetails()->page()->newGroupBox("midi 2 Internal Pedal");
  ...
  editDetails()->page()->addKnob(0, 1, 1, 1, "0B", "00", "3C");                        // Internal Pedal Time
	...
	editDetails()->page()->addGroupBox(0, 1, 2, 1);
	editDetails()->page()->newGroupBox("midi 2 Source");
  ...
  editDetails()->page()->addGroupBox(1, 0, 1, 1);
	...
	editDetails()->page()->newStackField(0);
	editDetails()->page()->newGroupBox("midi 3 Target");
	editDetails()->page()->addTarget(0, 0, 1, 3, "0B", "00", "41", "target","target", 120); // Target
	editDetails()->page()->addGroupBox(0, 0, 1, 1);
	editDetails()->page()->newGroupBox("midi 3 Internal Pedal");
  ...
  editDetails()->page()->addKnob(0, 1, 1, 1, "0B", "00", "4C");                        // Internal Pedal Time
	...
	editDetails()->page()->addGroupBox(0, 1, 2, 1);
	editDetails()->page()->newGroupBox("midi 3 Source");
  ...
  editDetails()->page()->addGroupBox(1, 0, 1, 1);
	...
	editDetails()->page()->newStackField(0);
	editDetails()->page()->newGroupBox("midi 4 Target");
	editDetails()->page()->addTarget(0, 0, 1, 3, "0B", "00", "51", "target","target", 120); // Target
	editDetails()->page()->addGroupBox(0, 0, 1, 1);
	editDetails()->page()->newGroupBox("midi 4 Internal Pedal");
  ...
  editDetails()->page()->addKnob(0, 1, 1, 1, "0B", "00", "5C");                        // Internal Pedal Time
	...
	editDetails()->page()->addGroupBox(0, 1, 2, 1);
	editDetails()->page()->newGroupBox("midi 4 Source");
  ...
  editDetails()->page()->addGroupBox(1, 0, 1, 1);
	...
	editDetails()->page()->newStackField(0);
	editDetails()->page()->newGroupBox("midi 5 Target");
	editDetails()->page()->addTarget(0, 0, 1, 3, "0B", "00", "61", "target","target", 120); // Target
	editDetails()->page()->addGroupBox(0, 0, 1, 1);
	editDetails()->page()->newGroupBox("midi 5 Internal Pedal");
  ...
  editDetails()->page()->addKnob(0, 1, 1, 1, "0B", "00", "6C");                        // Internal Pedal Time
	...
	editDetails()->page()->addGroupBox(0, 1, 2, 1);
	editDetails()->page()->newGroupBox("midi 5 Source");
  ...
  editDetails()->page()->addGroupBox(1, 0, 1, 1);
	...
	editDetails()->page()->newStackField(0);
	editDetails()->page()->newGroupBox("midi 6 Target");
	editDetails()->page()->addTarget(0, 0, 1, 3, "0B", "00", "71", "target","target", 120); // Target
	editDetails()->page()->addGroupBox(0, 0, 1, 1);
	editDetails()->page()->newGroupBox("midi 6 Internal Pedal");
  ...
  editDetails()->page()->addKnob(0, 1, 1, 1, "0B", "00", "7C");                        // Internal Pedal Time
	...
	editDetails()->page()->addGroupBox(0, 1, 2, 1);
	editDetails()->page()->newGroupBox("midi 6 Source");
  ...
  editDetails()->page()->addGroupBox(1, 0, 1, 1);
	...
	editDetails()->page()->newStackField(0);
	editDetails()->page()->newGroupBox("midi 7 Target");
	editDetails()->page()->addTarget(0, 0, 1, 3, "0C", "00", "01", "target","target", 120); // Target
	editDetails()->page()->addGroupBox(0, 0, 1, 1);
	editDetails()->page()->newGroupBox("midi 7 Internal Pedal");
  ...
  editDetails()->page()->addKnob(0, 1, 1, 1, "0C", "00", "0C");                        // Internal Pedal Time
	...
	editDetails()->page()->addGroupBox(0, 1, 2, 1);
	editDetails()->page()->newGroupBox("midi 7 Source");
  ...
  editDetails()->page()->addGroupBox(1, 0, 1, 1);
	...
	editDetails()->page()->newStackField(0);
	editDetails()->page()->newGroupBox("midi 8 Target");
	editDetails()->page()->addTarget(0, 0, 1, 3, "0C", "00", "11", "target","target", 120); // Target
	editDetails()->page()->addGroupBox(0, 0, 1, 1);
	editDetails()->page()->newGroupBox("midi 8 Internal Pedal");
  ...
  editDetails()->page()->addKnob(0, 1, 1, 1, "0C", "00", "1C");                        // Internal Pedal Time
	...
	editDetails()->page()->addGroupBox(0, 1, 2, 1);
	editDetails()->page()->newGroupBox("midi 8 Source");
