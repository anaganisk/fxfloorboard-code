...
{
  setLSB("1C", "00");
  editDetails()->patchPos(1894, 34, "1C", "00");    //192 sysx file offset and data length of chorus parameters x2,
        setEditPages();
};
...
void menuPage_assign7::setEditPages()
{
    ...
    editDetails()->page()->addSwitch(0, 0, 1, 1, "1C", "00", "00", "middle", Qt::AlignCenter);
    ...
    editDetails()->page()->addComboBox(0, 1, 1, 1, "1C", "00", "09");                    // Source Mode
    editDetails()->page()->addRange(0, 2, 1, 2, "1C", "00", "0A", "Structure");         // min/max range widget
