...
{ editDetails()->page()->newGroupBox("Effect");
	editDetails()->page()->addSwitch(0, 0, 1, 1, "0A", "00", "75", "middle", Qt::AlignCenter);
	...
	editDetails()->addPage();
	editDetails()->patchPos(2400, 8, "0A", "75");    // sysx file offset and data length of chorus parameters x2,
