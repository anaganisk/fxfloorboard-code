...
{ 
  ...
  this->gxgButton = new QRadioButton(tr("*.gxg Librarian file"), this );
...
{	
   ...
   b=b+2045;                                  // increment point to next *.syx patch in bulk.
