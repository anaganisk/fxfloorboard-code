...
{ 
  ...
  this->gxbButton = new QRadioButton(tr("*.gxb Librarian file"), this );
...
{	
   ...
   b=b+1777;                                  // increment point to next *.syx patch in bulk.
