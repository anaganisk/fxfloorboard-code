    ...
    : stompBox(parent)
{
	...
	setButton("00", "00", "00");
	editDetails()->patchPos(22, 260, "00", "00");
	setEditPages();
};
...
void stompbox_fx1::setEditPages()
{
  ...
  editDetails()->addPage();    
	...
	editDetails()->page()->addKnob(1, 0, 1, 1, "00", "00", "79");
	editDetails()->page()->addKnob(1, 1, 1, 1, "00", "00", "7A");
	editDetails()->page()->addKnob(0, 0, 1, 1, "00", "00", "7B");
	editDetails()->page()->addGroupBox(0, 1, 1, 1);

	editDetails()->page()->newGroupBox("High-Middle");
	editDetails()->page()->addKnob(1, 1, 1, 1, "00", "00", "7C");
	editDetails()->page()->addKnob(1, 0, 1, 1, "00", "00", "7D");
	editDetails()->page()->addKnob(0, 1, 1, 1, "00", "00", "7E");
	editDetails()->page()->addGroupBox(0, 2, 1, 1);
