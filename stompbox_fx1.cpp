...
{	
	...
	editDetails()->page()->addComboBox(0, 1, 1, 1, "00", "00", "02");	
	...
	editDetails()->page()->addKnob(0, 0, 1, 1, "00", "00", "03", "normal", "right", 90);
	editDetails()->page()->addKnob(0, 1, 1, 1, "00", "00", "04", "normal", "right", 90);
	...
	editDetails()->page()->addKnob(0, 0, 1, 1, "00", "00", "07", "normal", "right", 90);
	editDetails()->page()->addKnob(0, 1, 1, 1, "00", "00", "08", "normal", "right", 90);
	...
	editDetails()->page()->addKnob(0, 0, 1, 1, "00", "00", "0B", "normal", "right", 90);
	editDetails()->page()->addKnob(0, 1, 1, 1, "00", "00", "0C", "normal", "right", 90);
	...
	editDetails()->page()->addKnob(0, 0, 1, 1, "00", "00", "0E", "normal", "right", 90);
	editDetails()->page()->addKnob(0, 1, 1, 1, "00", "00", "0F", "normal", "right", 90);
	...
	editDetails()->page()->addKnob(0, 0, 1, 1, "00", "00", "11", "normal", "right", 90);
	editDetails()->page()->addKnob(0, 1, 1, 1, "00", "00", "12", "normal", "right", 90);
  ...
  // PAGE 5 ABOVE
	...
	editDetails()->page()->addKnob(0, 0, 1, 1, "00", "00", "14", "normal", "right", 90);
	editDetails()->page()->addKnob(0, 2, 1, 1, "00", "00", "15", "normal", "right", 90);
	editDetails()->page()->addGroupBox(1, 0, 1, 7);
	editDetails()->page()->addStackField();
  // PAGE 6 ABOVE
  ...
  editDetails()->page()->newGroupBox("Feedbacker");	
	...
	editDetails()->page()->newStackField(1);
	editDetails()->page()->newGroupBox("Feedbacker");	
	editDetails()->page()->addKnob(0, 3, 1, 1, "00", "00", "19", "normal", "right", 90);
	editDetails()->page()->addGroupBox(1, 0, 1, 7);
	editDetails()->page()->addStackField();
