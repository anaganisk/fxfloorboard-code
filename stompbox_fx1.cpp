...
// T-Wah 
  editDetails()->page()->newStackField(0);
   ...
   editDetails()->page()->newStackField(0); 
	...
	editDetails()->page()->addKnob(0, 0, 1, 1, "05", "00", "37", "slider");
	editDetails()->page()->addKnob(0, 1, 1, 1, "05", "00", "38", "slider");
	editDetails()->page()->addKnob(0, 2, 1, 1, "05", "00", "39", "slider");
	editDetails()->page()->addKnob(0, 3, 1, 1, "05", "00", "3A", "slider");
	editDetails()->page()->addKnob(0, 4, 1, 1, "05", "00", "3B", "slider");
	editDetails()->page()->addKnob(0, 5, 1, 1, "05", "00", "3C", "slider");
	editDetails()->page()->addKnob(0, 6, 1, 1, "05", "00", "3D", "slider");
	editDetails()->page()->addKnob(0, 7, 1, 1, "05", "00", "3E", "slider");
	editDetails()->page()->addKnob(0, 8, 1, 1, "05", "00", "3F", "slider");
	editDetails()->page()->addKnob(0, 9, 1, 1, "05", "00", "40", "slider");
	editDetails()->page()->addGroupBox(0, 0, 1, 1);
