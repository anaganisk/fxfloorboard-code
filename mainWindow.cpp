	...
	: QMainWindow(parent) */
{
	...
	this->setWindowTitle("GT-3 Fx FloorBoard");
...
void mainWindow::createActions()
{
	...
	helpAct = new QAction(/*QIcon(":/images/help.png"),*/ tr("GT-3 Fx FloorBoard &Help"), this);
	helpAct->setShortcut(tr("Ctrl+F1"));
	helpAct->setStatusTip(tr("....."));
	connect(helpAct, SIGNAL(triggered()), this, SLOT(help()));

	homepageAct = new QAction(/*QIcon(":/images/home.png"),*/ tr("GT-3 Fx FloorBoard &Webpage"), this);
...
void mainWindow::about()
{
	...
	{	
		QMessageBox::about(this, tr("GT-3 Fx FloorBoard - About"), 
			"GT-3 Fx FloorBoard, " + tr("version") + " " + version + "\n" + file.readAll());
	};
};
