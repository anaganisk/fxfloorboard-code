...
TARGET = "GT-ProFxFloorBoard"
DESTDIR = ../GT-ProFxFloorBoard
#else 
CONFIG += release
TARGET = "GT-ProFxFloorBoard"
DESTDIR = ./packager
...
win32 {
	exists("c:/Progra~1/SDK/Lib/WinMM.Lib") {	# <-- Change the path to WinMM.Lib here!
        ...
        exists("c:/PROGRA~1/MICROS~3/VC/PLATFO~1/Lib/WinMM.Lib") { # Path vs2005 (Vista)
            ...
            message("IN THIS (GT-ProFxFloorBoard.pro) FILE WHERE INDICATED")
        }
	}
	 HEADERS += 
...
macx {
	...
	INCLUDEPATH += ./macosx
	ICON = GT-ProFxFloorBoard.icns
	message(Including Mac OS X specific headers and sources...)
}


#Include file(s)
include(GT-ProFxFloorBoard.pri)

#Windows resource file
win32:RC_FILE = GT-ProFxFloorBoard.rc
