...
PLEASE FEEL FREE TO DONATE AS MANY TIMES AS YOU LIKE,
 ...
 JUST KEEP IN MIND THE MANY HOURS SPENT GETTING IT HERE. 
 I WOULD LOVE A BEER!!!.

GT-3FxFloorBoard: 
NOTE: THE FxFloorBoard PROJECT HAS ABSORBED A LOT OF MY TIME, 
SO FAR INVESTING OVER 7000 HOURS OF MY TIME OVER 4 YEARS, AND 
TO THE BEST OF MY KNOWLEDGE EVERYTHING SHOULD WORK CORRECTLY, 
BUT SOME FUNCTIONS MAY BE INCORRECT,
SO I WILL NOT ACCEPT LIABILITY FOR ANY DATA LOSS.
...
MultiWay ClipBoard for multi patch editing.
Partial Patch pasting of one effect to another patch.
SYSTEM EDITING added.
Assigns added.
now uses Qt library version 4.6.0

This project is a continuing session of evolution.

patch tree to the left side should give patch change on single click and (when 'connected in Bulk Mode' button active), double click should request patch transfer.
...
WIN: Run GT-3FxFloorBoard.exe installer
...
GT-3FxFloorBoard Copyright (C)2007~2010 Colin Willcocks <gumtownbassman@yahoo.com>.
based on the GT8 FxFloorBoard Copyright (C)2006~2007 Uco Mesdag.
