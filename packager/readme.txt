...
GT-10FxFloorBoard version 20100428: 28 April 2010
*****************************************************
...
e.) A single mouse pointer click on the Patch-Tree name will change the GT10 to that selected patch only 
- sound played through the GT10 will have the sound of that patch.
 
f.) A double click on the patch name will load the patch information from the Gt10 into the editor, 
