...
/* General Parameters */
const QString deviceType = "GT-10";
const QString idRequestString = "F07E000601F7";		// Indentity Request (GT-10).
const QString idReplyPatern = "F07E000602412F02";			// part of Returned device id message must contain/match this (QRegExp or a string without spaces and all caps).
...
const int patchSize = 1862;    // size of bytes in a patch.
