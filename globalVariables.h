...
/* General Parameters */
const QString deviceType = "GT-Pro";
const QString idRequestString = "F0410000000B1100000000000000017FF7";//"F07E000601F7";		// Indentity Request (GT-Pro).
const QString idReplyPatern = "F0410000000B12";//"F07E000602410B02";//000000000000F7";			// Returned device id message must contain/match this (QRegExp or a string without spaces and all caps).
...
const int bankTotalAll = 40;		// Number of total banks.
const int patchPerBank = 10;			// Number of patches in a bank.
