...
const int receiveTimeout = 50;		// Time (ms) we wait between SYSEX messages for the next one to be received.
const int receiveTimeoutMultiple = 950; // Time (ms) we wait for received patch to arrive after a request.
