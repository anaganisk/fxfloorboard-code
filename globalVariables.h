...
/* General Parameters */
const QString deviceType = "GT-5";
const QString idRequestString = "F0410000041100000000000000017FF7";		// Indentity Request (GT-5).
const QString idReplyPatern = "F04100000412";			// Returned device id message must contain/match this (QRegExp or a string without spaces and all caps).
...
const int sysxNameOffset = 412;		// Offset (starts at 0) where the data starts in a sysx message.
...
/* Midi Send & Receive */
const int patchPackets = 5;		// number of sysx packets "F0....F7" which make up a patch.
...
/* Patch addresses */
const QString chainAddress = "00";
const QString nameAddress = "05";
