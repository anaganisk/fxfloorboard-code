...
const QString idReplyPatern = "F07E000602412F02000000000000F7";			// part of Returned device id message must contain/match this (QRegExp or a string without spaces and all caps).
