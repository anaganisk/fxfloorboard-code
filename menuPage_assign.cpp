...
void menuPage_assign::setEditPages()
{
  ...
  editDetails()->page()->newGroupBox("Assign 1 Target");
	editDetails()->page()->addTarget(0, 0, 1, 4, "0F", "00", "01", "target", "03", "05"); // Target
	editDetails()->page()->addGroupBox(0, 0, 1, 1);
	editDetails()->page()->newGroupBox("Assign 1 Source");
	editDetails()->page()->addComboBox(0, 0, 1, 1, "0F", "00", "07");                    // Source
  editDetails()->page()->addComboBox(1, 0, 1, 1, "0F", "00", "08");                    // Source Mode
  editDetails()->page()->addRange(0, 2, 1, 2, "0F", "00", "09", "Structure");         // min/max range widget
  ...
  editDetails()->page()->addGroupBox(1, 0, 1, 1); 
	...
	editDetails()->page()->addTarget(0, 0, 1, 4, "10", "00", "01", "target", "03", "05"); // Target
	editDetails()->page()->addGroupBox(0, 0, 1, 1);
	editDetails()->page()->newGroupBox("Assign 2 Source");
	editDetails()->page()->addComboBox(0, 0, 1, 1, "10", "00", "07");                    // Source
  editDetails()->page()->addComboBox(1, 0, 1, 1, "10", "00", "08");                    // Source Mode
  editDetails()->page()->addRange(0, 2, 1, 2, "10", "00", "09", "Structure");         // min/max range widget
  ...
  editDetails()->page()->addGroupBox(1, 0, 1, 1);
	...
	editDetails()->page()->addTarget(0, 0, 1, 4, "11", "00", "01", "target", "03", "05"); // Target
	editDetails()->page()->addGroupBox(0, 0, 1, 1);
	editDetails()->page()->newGroupBox("Assign 3 Source");
	editDetails()->page()->addComboBox(0, 0, 1, 1, "11", "00", "07");                    // Source
  editDetails()->page()->addComboBox(1, 0, 1, 1, "11", "00", "08");                    // Source Mode
  editDetails()->page()->addRange(0, 2, 1, 2, "11", "00", "09", "Structure");         // min/max range widget
...
editDetails()->page()->newGroupBox("Assign 4 Target");
	editDetails()->page()->addTarget(0, 0, 1, 4, "12", "00", "01", "target", "03", "05"); // Target
	editDetails()->page()->addGroupBox(0, 0, 1, 1);
	editDetails()->page()->newGroupBox("Assign 4 Source");
	editDetails()->page()->addComboBox(0, 0, 1, 1, "12", "00", "07");                    // Source
  editDetails()->page()->addComboBox(1, 0, 1, 1, "12", "00", "08");                    // Source Mode
  editDetails()->page()->addRange(0, 2, 1, 2, "12", "00", "09", "Structure");         // min/max range widget
  ...
  editDetails()->page()->addGroupBox(1, 0, 1, 1);
	...
	editDetails()->page()->addTarget(0, 0, 1, 4, "13", "00", "01", "target", "03", "05"); // Target
	editDetails()->page()->addGroupBox(0, 0, 1, 1);
	editDetails()->page()->newGroupBox("Assign 5 Source");
	editDetails()->page()->addComboBox(0, 0, 1, 1, "13", "00", "07");                    // Source
  editDetails()->page()->addComboBox(1, 0, 1, 1, "13", "00", "08");                    // Source Mode
  editDetails()->page()->addRange(0, 2, 1, 2, "13", "00", "09", "Structure");         // min/max range widget
  ...
  editDetails()->page()->addGroupBox(1, 0, 1, 1);
	...
	editDetails()->page()->addTarget(0, 0, 1, 4, "14", "00", "01", "target", "03", "05"); // Target
	editDetails()->page()->addGroupBox(0, 0, 1, 1);
	editDetails()->page()->newGroupBox("Assign 6 Source");
	editDetails()->page()->addComboBox(0, 0, 1, 1, "14", "00", "07");                    // Source
  editDetails()->page()->addComboBox(1, 0, 1, 1, "14", "00", "08");                    // Source Mode
  editDetails()->page()->addRange(0, 2, 1, 2, "14", "00", "09", "Structure");         // min/max range widget
  ...
  editDetails()->page()->addGroupBox(1, 0, 1, 1);
	...
	editDetails()->page()->addTarget(0, 0, 1, 4, "15", "00", "01", "target", "03", "05"); // Target
	editDetails()->page()->addGroupBox(0, 0, 1, 1);
	editDetails()->page()->newGroupBox("Assign 7 Source");
	editDetails()->page()->addComboBox(0, 0, 1, 1, "15", "00", "07");                    // Source
  editDetails()->page()->addComboBox(1, 0, 1, 1, "15", "00", "08");                    // Source Mode
  editDetails()->page()->addRange(0, 2, 1, 2, "15", "00", "09", "Structure");         // min/max range widget
  ...
  editDetails()->page()->addGroupBox(1, 0, 1, 1);
	...
	editDetails()->page()->addTarget(0, 0, 1, 4, "16", "00", "01", "target", "03", "05"); // Target
	editDetails()->page()->addGroupBox(0, 0, 1, 1);
	editDetails()->page()->newGroupBox("Assign 8 Source");
	editDetails()->page()->addComboBox(0, 0, 1, 1, "16", "00", "07");                    // Source
  editDetails()->page()->addComboBox(1, 0, 1, 1, "16", "00", "08");                    // Source Mode
  editDetails()->page()->addRange(0, 2, 1, 2, "16", "00", "09", "Structure");         // min/max range widget
