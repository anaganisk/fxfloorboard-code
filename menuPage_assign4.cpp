...
{
  setLSB("19", "00");
  editDetails()->patchPos(1714, 34, "19", "00");    //192 sysx file offset and data length of chorus parameters x2,
        setEditPages();
};
...
void menuPage_assign4::setEditPages()
{
    ...
    editDetails()->page()->addSwitch(0, 0, 1, 1, "19", "00", "00", "middle", Qt::AlignCenter);
    ...
    editDetails()->page()->addComboBox(0, 1, 1, 1, "19", "00", "09");                    // Source Mode
    editDetails()->page()->addRange(0, 2, 1, 2, "19", "00", "0A", "Structure");         // min/max range widget
