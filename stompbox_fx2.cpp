    ...
    : stompBox(parent)
{
	...
	setLSB("06", "00");
//#ifdef Q_OS_MAC
//	setComboBox("06", "00", "01", QRect(4, 31, 88, 20));
//#else
...
void stompbox_fx2::setEditPages()
{
  ...
  editDetails()->page()->newGroupBox("Effect");
	...
	editDetails()->page()->addComboBox(0, 1, 1, 1, "06", "00", "02");     //voice
	editDetails()->page()->addStackControl();
	editDetails()->page()->addGroupBox(0, 0, 1, 7);
	editDetails()->page()->newGroupBox("Harmony 1");
	editDetails()->page()->addComboBox(0, 0, 1, 1, "06", "00", "03");     //mode
	editDetails()->page()->addKnob(0, 1, 1, 1, "06", "00", "04");         //hr1 pitch
	editDetails()->page()->addKnob(0, 2, 1, 1, "06", "00", "05");         //hr1 pitch fine
	editDetails()->page()->addComboBox(0, 3, 2, 1, "06", "00", "06");     //hr1 harmony
	editDetails()->page()->addKnob(0, 4, 1, 1, "06", "00", "07", "normal","right", 90);//hr1 pre delay
	editDetails()->page()->addKnob(0, 5, 1, 1, "06", "00", "09", "turbo");//hr1 feedback
	editDetails()->page()->addKnob(0, 6, 1, 1, "06", "00", "0A");         //hr1 level
	...
	editDetails()->page()->addGroupBox(2, 0, 1, 5);
	editDetails()->page()->addStackField();
	editDetails()->addPage("06", "00", "01", "00");  // PAGE 1 ABOVE
	...
	editDetails()->page()->addGroupBox(1, 0, 1, 7);
    editDetails()->addPage("06", "00", "01", "01");  // PAGE 2 ABOVE
	...
	editDetails()->addPage("06", "00", "01", "02");  // PAGE 3 ABOVE
	...
	editDetails()->page()->addKnob(0, 3, 1, 1, "06", "00", "24", "turbo");//tempo
	...
	editDetails()->page()->addGroupBox(2, 0, 1, 5);
	editDetails()->addPage("06", "00", "01", "03");  // PAGE 4 ABOVE


	editDetails()->page()->newGroupBox("Effect");
	editDetails()->page()->addSwitch(0, 0, 1, 1, "06", "00", "00", "middle", Qt::AlignCenter);        //on/off
	...
	editDetails()->addPage("06", "00", "01", "04");                       // PAGE 5 ABOVE 
	...
	editDetails()->page()->addGroupBox(1, 0, 1, 4);
	editDetails()->addPage("06", "00", "01", "05");                        // PAGE 6 ABOVE
	...
	editDetails()->page()->addKnob(0, 0, 1, 1, "06", "00", "3D", "turbo");//delay time
	...
	editDetails()->addPage("06", "00", "01", "06");                        // PAGE 7 ABOVE	
	...
	editDetails()->addPage("06", "00", "01", "07");                          // PAGE 8 ABOVE
	...
	editDetails()->page()->addGroupBox(1, 4, 1, 2);
	editDetails()->addPage("06", "00", "01", "08");                        // PAGE 9 ABOVE	
  ...
  editDetails()->page()->addGroupBox(0, 3, 1, 4);
  editDetails()->page()->newGroupBox("Filter");
	...
	editDetails()->page()->addKnob(0, 2, 1, 1, "06", "00", "51", "turbo");//pwm rate
	editDetails()->page()->addKnob(0, 3, 1, 1, "06", "00", "52");         //pwm depth
	editDetails()->page()->addKnob(0, 4, 1, 1, "06", "00", "53", "turbo");//cutoff freq
	editDetails()->page()->addKnob(0, 5, 1, 1, "06", "00", "54");         //resonance
	editDetails()->page()->addKnob(0, 6, 1, 1, "06", "00", "55");         //flt sens
	editDetails()->page()->addKnob(0, 7, 1, 1, "06", "00", "56");         //flt decay
	editDetails()->page()->addKnob(0, 8, 1, 1, "06", "00", "57", "turbo");//flt depth
	editDetails()->page()->addGroupBox(1, 0, 1, 9);
	editDetails()->page()->newGroupBox("Synth Filter");
	editDetails()->page()->addKnob(0, 0, 1, 1, "06", "00", "58", "turbo");//attack
	editDetails()->page()->addKnob(0, 1, 1, 1, "06", "00", "59");         //release
	editDetails()->page()->addKnob(0, 2, 1, 1, "06", "00", "5A", "turbo");//velocity
	editDetails()->page()->addComboBox(0, 3, 1, 1, "06", "00", "5B");     //hold
	editDetails()->page()->addGroupBox(2, 0, 1, 7);
	editDetails()->page()->newGroupBox("Output");
	editDetails()->page()->addKnob(0, 7, 1, 1, "06", "00", "5C");         //synth level
	editDetails()->page()->addKnob(0, 8, 1, 1, "06", "00", "5D", "turbo");//direct level
...
editDetails()->page()->newStackField(0);
	...
	editDetails()->page()->addStackField();
    */
	editDetails()->addPage("06", "00", "01", "09");                       // PAGE 10 ABOVE 
	...
	editDetails()->addPage("06", "00", "01", "0A");                        // PAGE 11 ABOVE
	...
	editDetails()->page()->addGroupBox(1, 0, 1, 4);
	editDetails()->addPage("06", "00", "01", "0B");                       // PAGE 12 ABOVE
