...
echo ***                   Build MENU for GT-5FxFloorBoard            ***
echo *                    -----------------------------------           *
...
:E-OPTION
c:\qt\4.6.0\bin\lupdate.exe GT-5FxFloorBoard.pro
pause
goto CHECK

:F-OPTION
c:\qt\4.6.0\bin\lrelease.exe GT-5FxFloorBoard.pro
pause
goto CHECK
