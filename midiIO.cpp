...
{			
		...
		//if (rxData.contains("F0410000000B12") || rxData.contains(idReplyPatern))
...
{	
  ...
  if (sysxOutMsg != idRequestString && sysxOutMsg.contains("F0410000000611000000000")) {system = true; multiple = false; };
