...
void stompBox::setSwitch(QString hex1, QString hex2, QString hex3)
{
	...
	switchbutton->move(QPoint::QPoint(5, 141)); 
};
...
void stompBox::updateStompPath()
{
	...
	if (this->id == 2) {this->hexdata_A = "02"; this->hexdata_B = "42"; this->namedata = "CH_A"; this->fxName = tr("PreAmp/Spkr");};
	if (this->id == 3) {this->hexdata_A = "03"; this->hexdata_B = "43"; this->namedata = "CH_B"; this->fxName = tr("GT-10 preamp");};
	...
	if (this->id == 10){this->hexdata_A = "0A"; this->hexdata_B = "4A"; this->namedata = "PDL";  this->fxName = tr("Pedal/Wha");};
	...
	if (this->id == 16){this->hexdata_A = "10"; this->hexdata_B = "10"; this->namedata = "CN_S"; this->fxName = tr("Channel Mode");};
