    ...
    : QWidget(parent)
{
  ...
  QObject::connect(this->parent(), SIGNAL(speaker_buttonSignal(bool)), this, SLOT(speaker_ButtonSignal(bool) )); 
  QObject::connect(this->parent(), SIGNAL(speaker_buttonSignal(bool)), this->parent(), SLOT(menuButtonSignal()));
  
  QObject::connect(this->parent(), SIGNAL(loop_buttonSignal(bool)), this, SLOT(loop_ButtonSignal(bool) )); 
  QObject::connect(this->parent(), SIGNAL(loop_buttonSignal(bool)), this->parent(), SLOT(menuButtonSignal()));
  
  QObject::connect(this->parent(), SIGNAL(tp_buttonSignal(bool)), this, SLOT(tp_ButtonSignal(bool) )); 
  QObject::connect(this->parent(), SIGNAL(tp_buttonSignal(bool)), this->parent(), SLOT(menuButtonSignal()));
...
void stompBox::loop_ButtonSignal(bool value)	
{  
    if (this->id == 3)
    { 
      emitValueChanged(this->hex1, this->hex2, "00", "void");
...
void stompBox::speaker_ButtonSignal(bool value)	
{  
    if (this->id == 6)
    { 
      emitValueChanged(this->hex1, this->hex2, "00", "void");
...
void stompBox::tp_ButtonSignal(bool value)	
{  
    if (this->id == 11)
    { 
      emitValueChanged(this->hex1, this->hex2, "00", "void");
...
{
  if (this->id == 0) { this->fxName = tr("Feedbacker/SlowGear");};
	if (this->id == 1) { this->fxName = tr("Compressor/Limiter");};
	if (this->id == 2) { this->fxName = tr("Wah");};
	if (this->id == 3) { this->fxName = tr("Send/Return Loop");};
	if (this->id == 4) { this->fxName = tr("Distortion");};
	if (this->id == 5) { this->fxName = tr("PreAmp");};
	if (this->id == 6) { this->fxName = tr("Speaker Cabinet");};
	if (this->id == 7) { this->fxName = tr("Equalizer");};
	if (this->id == 8) { this->fxName = tr("Modulation");};
	if (this->id == 9) { this->fxName = tr("Delay");};
	if (this->id == 10){ this->fxName = tr("Chorus");};
	if (this->id == 11){ this->fxName = tr("Tremolo/Pan");};
	if (this->id == 12){ this->fxName = tr("Reverb");};
	if (this->id == 13){ this->fxName = tr("Noise Suppressor");};
	if (this->id == 14){ this->fxName = tr("FV/CTL/Master");};
